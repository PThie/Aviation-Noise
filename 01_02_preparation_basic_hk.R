...
# -------------------------------------------------------------------------
# split up data to make distance calculates faster 
...
# ##### function to calculate distance
# ind_noise_distance <- function(data.sf){
#   
#   # calculate distance for each data set
#   data.sf$distance_industry <- as.numeric(apply(st_distance(data.sf, industry_noise), 1, min)) / 1000
#   
#   # return
#   return(data.sf)
# }
# 
# ##### apply function to subsets
# red_geo1 <- ind_noise_distance(red_geo1)
# red_geo2 <- ind_noise_distance(red_geo2)
# red_geo3 <- ind_noise_distance(red_geo3)
# red_geo4 <- ind_noise_distance(red_geo4)
...
saveRDS(nearest, file.path(dataFlug, "housing/Temp/nearest_streets_hk.rds"))
...
saveRDS(red_geo, file.path(dataFlug, "housing/Temp/red_HK_prepared.rds"))
