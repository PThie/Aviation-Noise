intersection_rings <- function(housing_data, contour_data) {
	...
	#'
	#' @description This function returns indicators for housing objects within
	#' airport contours.
	#'
	...
	housing_data$con_ring3[
		housing_data$con_ring1 == 1 |
	...
	housing_data$con_ring0[
		housing_data$con_ring1 == 1 |
		housing_data$con_ring2 == 1 |
		housing_data$con_ring3 == 1 |
		housing_data$con_ring4 == 1 |
		housing_data$con_ring5 == 1
	] <- 1
